...
void drawEyes(){
  ...
  // pupils
  float xPupilL = - faceWidth/4+pupilSize/5, yPupilL = (topHeight + middleHeight + bottomHeight)/2.1 ; 
  float xPupilR = faceWidth/4-pupilSize/5, yPupilR = (topHeight + middleHeight + bottomHeight)/2.1 ;
  
  fill(240);
  noStroke();
  ellipse(xPupilL-pupilSize*.12,yPupilL+pupilSize*.24, pupilSize*2.2,pupilSize);
  ellipse(xPupilR+pupilSize*.12,yPupilR+pupilSize*.24, pupilSize*2.2,pupilSize);
  
  fill(50);
  stroke(110);
  strokeWeight(pupilSize*.16);
  ellipse(xPupilL-pupilSize*.12,yPupilL+pupilSize*.24, pupilSize*1.35, pupilSize*1.1);
  ellipse(xPupilR+pupilSize*.12,yPupilR+pupilSize*.24, pupilSize*1.35, pupilSize*1.1);
  
  // sparkle in the pupils
  noStroke();
  fill(200);
  ellipse(xPupilL-2-pupilSize/4,yPupilL+2+pupilSize/4,pupilSize*.16,pupilSize*.24);
  ellipse(xPupilR+2-pupilSize/4,yPupilR+2+pupilSize/4, pupilSize*.16,pupilSize*.24);
  rect(xPupilL-2-pupilSize/4,yPupilL+2+pupilSize/4,pupilSize*.32,pupilSize*.16);
  rect(xPupilR+2-pupilSize/4,yPupilR+2+pupilSize/4,pupilSize*.32,pupilSize*.16);
 ...
 // left eyelid
  ...
  curveVertex(xPupilL,yPupilL-pupilSize*.49);
  curveVertex(xLidLeftEnd,yLidLeftEnd);
  curveVertex(xLidLeftEnd+pupilSize/4,yLidLeftEnd+pupilSize);
  endShape();
  // 2nd left lid 
  stroke(70);
  strokeWeight(pupilSize/5);
  beginShape();
  curveVertex(xLidLeftStart,yLidLeftStart);
  curveVertex(xLidLeftStart + pupilSize/2,yLidLeftStart-pupilSize/4);
  curveVertex(xPupilL,yPupilL-pupilSize*.4);
  curveVertex(xLidLeftEnd,yLidLeftEnd);
  curveVertex(xLidLeftEnd+pupilSize/4,yLidLeftEnd+pupilSize);
  endShape();
 ...
 beginShape();
  ...
  curveVertex(xPupilR,yPupilR-pupilSize*.4);
 ...
 endShape();
  ...
  curveVertex(xLidRightStart - pupilSize/2,yLidRightStart-pupilSize/4);
  curveVertex(xPupilR,yPupilR-pupilSize*.4);
...
//  GLASSES
  ...
  stroke(50);
  strokeWeight(pupilSize*.32);
  float xRectCenterLeft = xPupilL-pupilSize*.76 , yRectCenterLeft = yPupilL+pupilSize*.8;
  float xRectCenterRight = xPupilR+pupilSize*.76 , yRectCenterRight = yPupilL+pupilSize*.8;
  float rectLength = faceWidth/2.5;
  float rectWidth = faceWidth * .2;
  rect(xRectCenterLeft,yRectCenterLeft,rectLength, rectWidth,pupilSize*.8);
  rect(xRectCenterRight,yRectCenterRight,rectLength, rectWidth,pupilSize*.8);
